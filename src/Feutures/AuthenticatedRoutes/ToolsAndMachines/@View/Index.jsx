...
const AddToolOrMachineModal = ({ onClose, isOpen, onRenderPage }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      onRenderPage();
      toast({
        title: "تم انشاء الجهاز بنجاح",
        status: "success",
      });
    } catch (err) {
      toast({
        title: "خطأ في انشاء الجهاز",
  ...
  return (
    ...
    >
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>اضافة الاداه او الجهاز</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <InputElement
            errors={errors}
