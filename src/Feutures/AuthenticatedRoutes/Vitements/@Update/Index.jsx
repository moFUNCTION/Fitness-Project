...
export default function Index() {
  ...
  const UpdateVitaminHelper = useCallback(async (data) => {
    const req = await axiosInstance.put(`/vitamins/${id}`, data, {
      headers: {
        Authorization: `Bearer ${user.data.token}`,
      },
    });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await UpdateVitaminHelper(DataSend);
  ...
  return (
    <>
      ...
      >
        <Heading size="md">تحديث فيتامين</Heading>
        <Divider />
